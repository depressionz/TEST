...
public class level4 extends AppCompatActivity {
    ...
    String quizData[][] = {
            ...
            {"Put", "Класть", "Послать", "Делать"},
            {"Run", "Бежать", "Сказать", "Учить"},
            {"Take", "Взять", "Встречать", "Обучать"},
            {"Forget", "Забывать", "Сказать", "Покупать"},
            {"Buy", "Покупать", "Сказать", "Смотреть"},
            {"Spend", "Тратить", "Резать", "Падать"},
            {"Grow", "Расти", "Знать", "Учить"},
            {"Send", "Посылать", "Строить", "Сказать"},
            {"Build", "Строить", "Получать", "Ударять"},
